...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
      ...
      digits: "Phải là số nhị phân.",
      alphanum: "Phải là kiểu kí tự."
  },
  notblank: "Không được rỗng.",
  required: "Thông tin bắt buộc.",
  pattern: "Không đúng cấu trúc.",
  min: "Giá trị phải lớn hơn hoặc bằng %s.",
  max: "Giá trị phải nhỏ hơn hoặc bằng %s.",
  range: "Giá trị phải nằm trong khoảng từ %s đến %s.",
  minlength: "Chuỗi quá ngắn. Phải ít nhất từ %s kí tự trở lên.",
  maxlength: "Chuỗi quá dài. Phải ít hơn hoặc bằng %s kí tự.",
  length: "Chiều dài chuỗi không hợp lệ. Chuỗi nằm trong khoảng từ %s từ %s kí tự.",
  mincheck: "Phải chọn ít nhất %s mục.",
  maxcheck: "Phải chọn ít hơn %s mục.",
  check: "Phải chọn trong khoảng từ %s đến %s mục.",
