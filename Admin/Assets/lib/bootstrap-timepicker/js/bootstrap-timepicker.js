    ...
    Timepicker.prototype = {
        ...
        decrementHour: function () {
            if (this.showMeridian) {
                ...
                if (this.hour <= 0 || this.hour <= this.minHour) {
                    this.hour = this.maxHour;
                } else {
                    this.hour--;
                }
            }
            if (this.minHour === this.hour) { this.minute = 30; }
        },
					  ...
					  '<div class="modal-dialog">' +
						'<div class="modal-content">' +
							...
							'<div class="modal-footer">' +
							  '<button class="btn btn-master" data-dismiss="modal">OK</button>' +
							'</div>' +
						'</div>'+
					  '</div>'+
                    '</div>';
        ...
        incrementHour: function () {
            ...
            if (this.hour === 23  || this.hour === this.maxHour) {
