...
function render(wizard, options, state)
{
    ...
    var wrapperTemplate = "<{0} class=\"{1}\">{2}</{0}>",
        ...
        stepsWrapper = $(format(wrapperTemplate, options.stepsContainerTag, "steps " + options.clearFixCssClass, "<ul class=\"list-unstyled\" role=\"tablist\"></ul>")),
...
function renderPagination(wizard, options, state)
{
    if (options.enablePagination)
    {
        var pagination = "<{0} class=\"actions {1}\"><ul class=\"list-unstyled wizard_pagination\" role=\"menu\" aria-label=\"{2}\">{3}</ul></{0}>",
            buttonTemplate_prev = "<li class=\"pull-left\"><a href=\"#{0}\" class=\"btn btn-default\" role=\"menuitem\">{1}</a></li>",
            buttonTemplate_next = "<li class=\"pull-right\"><a href=\"#{0}\" class=\"btn btn-master\" role=\"menuitem\">{1}</a></li>",
            buttonTemplate_finish = "<li class=\"pull-right\"><a href=\"#{0}\" class=\"btn btn-master\" role=\"menuitem\">{1}</a></li>",
            buttons = "";
