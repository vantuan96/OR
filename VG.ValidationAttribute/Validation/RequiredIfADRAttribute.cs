...
namespace VG.ValidAttribute.Validation
{
    ...
    public sealed class RequiredIfADRAttribute : PropertyValidationAttribute
    {
        #region Fields
        ...
        public RequiredIfADRAttribute(string otherPropertyName, object compare, ValueComparison comparison)
